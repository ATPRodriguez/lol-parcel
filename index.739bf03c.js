...
var _campeonJs = require("./campeon.js");
var _campeonJsDefault = parcelHelpers.interopDefault(_campeonJs);
var campeones = [];
var mapsList = [];
...
const startGenerating = async ()=>{
    await fetch("https://ddragon.leagueoflegends.com/cdn/13.18.1/data/es_ES/champion.json").then(function(result) {
        ...
        for(let champion in result.data){
            ...
            let campeon = new (0, _campeonJsDefault.default)(data);
...
const showCampeones = async ()=>{
    ...
    for(var i = 0; i < campeones.length; i++)campeonesList.innerHTML += `<div class="card">                                    
...
const startGeneratingMaps = async ()=>{
    ...
    for(let i = 0; i < mapsList.length; i++)maps.innerHTML += `<div class="map">
                                    <img src="${mapsList[i]}"/>
                                </div>`;
};
function llenarMaps() {
...
},{"./campeon.js":"6ttRZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6ttRZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequire12ba")
